#nessa versão, aprimorei a interação do código com o usuário. 
#aumentei o leque de opções, para que o usuário tenha a opção de criar um novo perfil, caso ainda não possua.
