#Versão dedicada à implementação de listas, para armazenar os dados de novos usuários. 
#Na opção 'login' dessa versão, não haverá um usuário e senha pré-definidos, como nas versões anteriores.
